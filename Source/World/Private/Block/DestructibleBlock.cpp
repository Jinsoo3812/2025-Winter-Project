...
void ADestructibleBlock::BeginPlay()
{
	...
	else UE_LOG(LogTemp, Error, TEXT("DestructibleBlock: AbilitySystemComponent is null in %s"), *GetName());
	...
	else UE_LOG(LogTemp, Error, TEXT("DestructibleBlock: BlockAttributeSet is null in %s"), *GetName());
}
